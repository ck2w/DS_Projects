...
visualize_attr_maps('visualization/gbp_ggc.png', X, y, class_names,
                    [attr_ggc, attr_gbp],
...
visualize_attr_maps('visualization/visualize_layers.png', X, y, class_names,
                    [layer_con_attr_sum, layer_gc_attr_sum],
                    ['Layer Conductance', 'Layer GradCam'],
                    )
