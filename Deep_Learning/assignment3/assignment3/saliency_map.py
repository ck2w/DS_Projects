...
sali_attr = compute_attributions(saliency, X_tensor, target=y_tensor)
visualize_attr_maps('visualization/saliency_captum.png', X, y, class_names, [sali_attr], ['Saliency'])
