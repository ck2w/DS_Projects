...
import unittest
import numpy as np
from part1_convnet.optimizer import SGD
from part1_convnet.modules import ConvNet
from part1_convnet.tests.utils import *
...
class TestSGD(unittest.TestCase):
    ...
    def test_sgd(self):
        ...
        expected_weights = np.load('part1_convnet/tests/sgd_weights/w.npy')
        expected_bias = np.load('part1_convnet/tests/sgd_weights/b.npy')
